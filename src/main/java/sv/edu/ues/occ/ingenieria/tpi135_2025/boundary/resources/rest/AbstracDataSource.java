 ...
 * @author mjlopez
 * @param <T> 
 * Clase abstracta que implementa el patrón de diseño Fabrica Abstracta.
 * Proporciona métodos genéricos para exponer los datos mediante rest.
 *
 */
public abstract class AbstracDataSource<T> implements Serializable {
    ...
    /**
     * metodo generico para la obtencion del id el cual pued ser integer o Long dependiendo del caso
     * @param registro
     * @return id de la entidad
     */
    public abstract Number getId(T registro);
    /**
     ...
     * @return una lista de tipo T si no definel los parametros entonces devuelve los primeros 20 registros
     */
    @GET
     ...
     * un estatus 500 en dado caso falle el servidor
     * un estatus 404 si no se encuentra ningun registro con el id especificado
     * 400 si se envia mal una parametro
     */
     ...
     * @return un estatus 201 si la entidad es creada junto con la url donde se puede encontra dicha entidad
     * 422 en dado caso falle la creacion de la entidad y 500 si por fall el servidor
     */
    @POST
    @Produces({MediaType.APPLICATION_JSON})
 ...
 * @return un status 200 si se borro la entidad , un 422 si hubo un problema y 500 si falla el servdor
 */
    @DELETE
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes({MediaType.APPLICATION_JSON})
     ...
     * @param uriInfo info de url de donde se esta realizado la peticion
     * @return  un status 200 si se actualizo la entidad , un 422 si hubo un problema y 500 si falla el servidor
     */
    @PUT
    @Produces({MediaType.APPLICATION_JSON})
    @Consumes({MediaType.APPLICATION_JSON})
